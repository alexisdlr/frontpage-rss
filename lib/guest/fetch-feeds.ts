...
import { mapWithConcurrency } from "@/lib/guest/concurrency";
import { GUEST_FETCH_CONCURRENCY } from "@/lib/guest/constants";
import { guestItemId } from "@/lib/guest/ids";
import type { GuestFeedDefinition } from "@/lib/guest/sample-data";
import type { GuestFeedFetchResult } from "@/lib/guest/types";

import type { FeedItemWithMeta } from "@/types/actions";
...
export async function fetchGuestFeedResults(
  ...
  return mapWithConcurrency(feeds, GUEST_FETCH_CONCURRENCY, fetchSingleGuestFeed);
}
