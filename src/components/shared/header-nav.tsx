...
const HeaderNav = ({ user, categories }: Props) => {
  ...
  const isDashboard = pathname === "/dashboard" || pathname === "/guest";
            ...
            {user ? (
              ...
              <div className="flex items-center gap-2">
                ...
                {isGuestMode ? (
                  ...
                  <Link
                    href="/guest"
                    className="flex min-h-11 items-center justify-center rounded-lg border border-border bg-surface px-5 py-2.5 text-sm text-text-primary transition-colors hover:bg-bg-secondary font-bold"
                  >
